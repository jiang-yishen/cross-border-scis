...
config = """    create_pie_chart, create_heatmap, apply_plotly_theme
)
...
print("OK: Step 1 - config inserted")

# Step 2: 在 "# 主入口" 注释前插入 page_login() 函数
...
print("OK: Step 2 - login func inserted")

# Step 3: 修改 main()
old_main = """    set_page_config()
    apply_custom_css()
    
    # 侧边栏导航"""
new_main = """    set_page_config()
    apply_custom_css()
